...
public class FamousQuotes {
    ...
    private static String[] quotes = {"1.Can you goback in time? no!, jump to the future? no! but you can learn from the past and fix your future",
    ...
    {
        int random = (int) (Math.random()* 10); // gives a random number in between 10
